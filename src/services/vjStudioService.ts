// src/services/VJStudioService.ts
...
// ==============================================
// VJ Studio Service â€“ Selfie with VJ Feature
// ==============================================
 ...
 *   POST /api/vj-studio/selfie/generate
 *
 ...
 *
 *   GET /api/vj-studio/selfie/quota
 */
 ...
 *
 *   GET /api/vj-studio/selfie/history
 */
export const fetchSelfieHistory = async () => {
  const response = await axiosClient.get('/vj-studio/selfie/history');
  return response.data;
};
 ...
 *
 *   GET /api/vj-studio/selfie/:id/download
 */
export const downloadCleanSelfie = async (id: string | number): Promise<Blob> => {
  const response = await axiosClient.get(`/vj-studio/selfie/${id}/download`, {
    responseType: 'blob',
  });
