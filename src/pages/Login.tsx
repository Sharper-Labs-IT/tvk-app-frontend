            ...
            <div className="bg-[#121212] sm:bg-[#1E1E1E] sm:border sm:border-gray-800 p-8 sm:p-10 lg:p-12 rounded-2xl shadow-2xl">
              ...
              >
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full bg-white text-gray-700 font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors border border-gray-300 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                >
