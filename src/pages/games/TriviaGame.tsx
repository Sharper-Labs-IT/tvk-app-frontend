...
const QUESTION_POOL: Question[] = [
  ...
  { id: 1, question: "What is Thalapathy VJ's debut movie as a lead actor?", options: ["Vetri", "Naalaiya Theerpu", "Sendhoorapandi", "Rasigan"], correctAnswer: 1 },
  ...
  { id: 3, question: "What is the title of VJ's 50th film?", options: ["Sura", "Vettaikaran", "Kaavalan", "Velayudham"], correctAnswer: 0 },
  { id: 4, question: "Which film gave VJ the title 'Ilayathalapathy'?", options: ["Rasigan", "Rajavin Parvaiyile", "Poove Unakkaga", "Love Today"], correctAnswer: 0 },
  { id: 5, question: "In which movie did VJ act alongside Surya?", options: ["Nerrukku Ner", "Friends", "Both A & B", "Kaavalan"], correctAnswer: 2 },
  { id: 6, question: "Who directed the blockbuster movie 'Pokkiri'?", options: ["Perarasu", "Prabhu Deva", "Dharani", "Ramana"], correctAnswer: 1 },
  { id: 7, question: "What is the name of VJ's character in the movie 'Thuppakki'?", options: ["Jagadish", "Joseph", "Saravanan", "Vetri"], correctAnswer: 0 },
  ...
  { id: 9, question: "Which movie marked the first collaboration between VJ and Atlee?", options: ["Mersal", "Bigil", "Theri", "Raja Rani"], correctAnswer: 2 },
  { id: 10, question: "In 'Nanban', VJ's character is a remake of which Bollywood character?", options: ["Rancho (3 Idiots)", "Munna Bhai", "Bajrangi", "Kabir Singh"], correctAnswer: 0 },
  ...
  { id: 12, question: "In which movie did VJ play a triple role for the first time?", options: ["Bigil", "Theri", "Mersal", "Puli"], correctAnswer: 2 },
  ...
  { id: 17, question: "What is the title given to VJ by his fans?", options: ["Thalaivar", "Thalapathy", "Ulaganayagan", "Superstar"], correctAnswer: 1 },
  { id: 18, question: "What is the name of VJ's father?", options: ["S.A. Chandrasekhar", "Bharathiraja", "Gangai Amaran", "T. Rajendar"], correctAnswer: 0 },
  { id: 19, question: "In which movie did VJ's son, Jason Sanjay, make a cameo appearance?", options: ["Vettaikaran", "Villu", "Sura", "Pokkiri"], correctAnswer: 0 },
  { id: 20, question: "Which of these movies features VJ as a football coach?", options: ["Thalaivaa", "Bigil", "Kaththi", "Jilla"], correctAnswer: 1 },
  { id: 21, question: "Which song did VJ sing in 'Leo'?", options: ["Naa Ready", "Badass", "Bloody Sweet", "Ordinary Person"], correctAnswer: 0 },
  ...
  { id: 24, question: "How many movies have VJ and Director A.R. Murugadoss collaborated on?", options: ["2", "3", "4", "5"], correctAnswer: 1 },
  { id: 25, question: "Which movie features VJ alongside Mohanlal?", options: ["Jilla", "Velayudham", "Kaavalan", "Puli"], correctAnswer: 0 },
  { 
    id: 26, 
