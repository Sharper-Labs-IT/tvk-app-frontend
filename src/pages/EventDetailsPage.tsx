          ...
          <section className="grid lg:grid-cols-[minmax(0,2fr),minmax(0,1fr)] gap-6">
            ...
            <div className="rounded-2xl bg-slate-900/80 border border-slate-700/70 p-5 sm:p-6 space-y-3">
              ...
              <p className="text-[11px] sm:text-xs text-neutral-400 leading-relaxed">
                This is a sample details page. Later, this section can include a
                richer long description from the backend (what to expect,
                schedule, dress code, who will appear, etc.).
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-2xl bg-slate-900/80 border border-slate-700/70 p-5 sm:p-6 space-y-3">
                ...
                <ul className="space-y-2 text-[11px] sm:text-xs text-neutral-300 list-disc list-inside">
                  ...
                  <li>
                    Photography and recording may be restricted during certain
                    segments.
                  </li>
                  <li>
                    Further details (tickets, QR codes, etc.) will be emailed
                    after registration.
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-2xl bg-slate-900/60 border border-yellow-500/30 p-5 sm:p-6 space-y-2">
                ...
                <p className="text-[11px] sm:text-xs text-neutral-200">
                  Attending this event may reward you with TVK membership points
                  and early access to future experiences. Exact points and
                  perks can be wired from the backend later.
                </p>
              </div>
            </div>
          </section>
