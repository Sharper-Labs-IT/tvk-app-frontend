          ...
          >
            ...
            <div className="lg:col-span-5 flex flex-col space-y-10 relative z-10">
              ...
              <motion.div variants={itemVariants} className="w-full flex justify-start">
                <div className="w-full max-w-md bg-[#111] border border-brand-gold/30 rounded-xl p-6 shadow-2xl">
            ...
            {/* Middle Column - Gold Cup (Span 4 - Centered) */}
            <div className="lg:col-span-4 flex justify-center items-center z-20">
              <motion.div
                variants={itemVariants}
                whileHover={{ scale: 1.05 }}
                className="relative bg-[#1a1a1a] border-2 border-brand-gold rounded-2xl p-8 w-80 xl:w-96 h-72 flex flex-col items-center justify-center shadow-[0_30px_60px_rgba(0,0,0,0.6)]"
              >
