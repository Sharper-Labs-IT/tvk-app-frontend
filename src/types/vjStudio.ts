// src/types/VJStudio.ts

// =============================================
// VJ Studio â€“ Selfie with VJ Feature Types
// =============================================

/** The current stage of the selfie generation workflow */
export type VJStudioState =
...
/** Payload sent to /api/vj-studio/generate */
export interface GenerateSelfieRequest {
  /** The selfie file (multipart upload â€“ handled by service) */
  file: File;
}
